...
""" A sample run statement is:
    ...
    nohup python3 /Users/helmutsimon/repos/NeutralityTest/chr7_gene_cluster.py
    001 7 142552000 2500 44 50000 --demog > o.txt&"""
...
@click.option('--demog/--no-demog', default=False,
              help='choos whether to implement non-neutral demographic history for European populations.')
